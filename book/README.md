...
This book is intended to be a community project that's authored in [Markdown][markdown] and showcases the majesty of [ColdFusion][coldfusion]. I've done my best to make it as easy as possible to contribute. But, collaborating across GitHub accounts isn't the easiest concept in the world. There is some necessary complexity.
...
When you're ready, push your branch and open a pull request (see previous section).
